...
func request_ProductInfo_SayHello_0(ctx context.Context, marshaler runtime.Marshaler, client ProductInfoClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_ProductInfo_SayHello_0(ctx context.Context, marshaler runtime.Marshaler, server ProductInfoServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq HelloRequest
	var metadata runtime.ServerMetadata
...
func RegisterProductInfoHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ProductInfoServer) error {
	...
	mux.Handle("POST", pattern_ProductInfo_SayHello_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/proto.ProductInfo/SayHello", runtime.WithHTTPPathPattern("/v1/greeter/say_hello"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_ProductInfo_SayHello_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		...
		forward_ProductInfo_SayHello_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterProductInfoHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ProductInfoClient) error {
	...
	mux.Handle("POST", pattern_ProductInfo_SayHello_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/proto.ProductInfo/SayHello", runtime.WithHTTPPathPattern("/v1/greeter/say_hello"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_ProductInfo_SayHello_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_ProductInfo_SayHello_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "greeter", "say_hello"}, ""))
)

var (
	forward_ProductInfo_SayHello_0 = runtime.ForwardResponseMessage
)
